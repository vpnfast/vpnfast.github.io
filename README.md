...
而目前最稳定的方式还是使用具有代理协议的VPN梯子。原理就是**把请求伪装成访问国外正规网站**（不在黑名单之内的，比如[本站的Github页面](https://github.com/vpnfast/vpnfast.github.io)就没有被墙），然后防火长城就会以为，你访问外网是为了翻墙出去学习科学技术，强国兴邦的。所以就叫做代理，理解起来其实非常简单。
...
VPN一开始是为企业提供安全数据加密的，后面被中国网友用来翻墙，这是利用了VPN软件的安全性和隐私性。当然并不是所有[翻墙VPN](https://vpnfast.github.io/)都能用于科学上网，并且可以说**安卓Google Play、苹果App Store中的大部分VPN都是垃圾**。
...
**🚀🚀🚀🚀以下翻墙软件经过我的测试，在中国的稳定性、速度都不错，有些是翻墙VPN软件**，有些是安全的机场/梯子，可以根据自己需求选择合适的科学上网工具。在本篇在中国VPN推荐指南中，我将详细测评每款科学上网软件的使用情况。
