...
当然这里并不是说全部的[国外翻墙VPN都值得推荐](https://howandbest.com/best-vpn/)，相反大部分国外付费VPN都不值得你去下载使用。因为大多数国外翻墙VPN都没有重视中国市场，还是使用的传统VPN协议，没有研发专用的翻墙模式。而**免费VPN由于背景不明确，存在诸多安全隐患**，很可能靠收集用户信息或者植入木马病毒来盈利，因此一概不推荐免费翻墙VPN，本文后半部分会详细介绍。
...
非中立的科学上网工具，不确定能不能用，但仍在更新。

> 无界浏览除了具备基于微软浏览器（IE）的全透明加密代理之外，启用了新发明的名为雄鹰之路的超级代理服务器连接技术，能够搜寻协调全球各种代理服务器资源供用户使用，速度快，容量无限大，为全球网络自由技术平台奠定基础。
> 
> 使用无界浏览，用户就象使用一般微软浏览器（IE）一样浏览任意网站，无界浏览在后台自动寻找最快速的代理服务器，并在整个过程中对所有浏览的内容进行超高程度的加密，加密程度超过国际金融网络传输安全标准。
> 
> 无界浏览实现了用户使用互联网的几乎所要求的一切基于HTTP的功能，如浏览各种网页，论坛上帖，网页注册，使用Webmail、数据上下传输，声音、图像、动画和电影的实时播放和下载，等等。详见无界浏览使用说明。
> 
> 来源 http://www.wujieliulan.com/download.php

#### 15.Freegate（自由门）

一款非中立的科学上网工具，从下载页看仍在活跃更新，网上有资料显示国内公安系统内有用它翻墙上网的，软件免费，但**隐私保护能力有严重缺陷，非常不建议使用**：
...
> 
> 还有，已经发生了好几起冒牌自由门的恶意软件，而不是根据传送协议的软件，被下载安装在用户计算机上。由于动态网发布了许多不同版本的自由门，这可能会给用户造成混乱： 他们无法知道并确信使用的版本是否货真价实。
> 
> …  
> 来源：https://projects.voanews.com/circumvention/chinese/freegate

#### 16.Psiphon（赛风）

据我了解，赛风当前无法用来从中国翻墙，从博客更新记录看，赛风很可能已停止更新，但近几年在海外不少翻墙社区中传播讨论，我觉得仍然值得介绍。赛风由位于加拿大的团队开发，能基于VPN，SSH和HTTP代理自动搜寻连接可用节点，支持Android，iOS，macOS，Windows，完全免费，也可购买加速版。官网在此，对Psiphon技术细节感兴趣的读者也参考这个指南。

#### 17.Ghelper（谷歌上网助手）

谷歌上网助手是一个浏览器插件，以支持Chrome浏览器为主，目前仍在更新。网上也能查到插件的Firefox版本和Android APP，但已久未更新，且无法确定是否为原作者开发，不建议读者下载该工具的非Chrome版本。

#### 18.ChromeGo

为Chrome浏览器构建，集成9个不同的翻墙通道：clash、clashB、v2ray、v2rayb、v2go、SSR、SS、Lantern、psiphon，所有工具全部内置免费服务器，仍在更新，Github项目页。个人没用过，但看项目状态，应该仍然可用，据我了解，SS，Lantern，Psiphon通道应该是全中国都用不了，但V2ray，Clash的部分节点应该在某些地区保持着可用性，可以用来临时翻墙。

#### 19.Geph（迷雾通）

最早在国外某论坛上看到这个工具，网传很能用，个人倒是没用过，了解不多。只能从官网找到有限的信息，读者注意，这类软件因其存在的风险性，须谨慎对待官方自己披露的信息。从官网得知，迷雾通总部在爱沙尼亚，受欧洲隐私法规约束，采用自研技术保障穿墙能力和用户数据安全，承诺封几天赔几天（从用户论坛看做不到100%翻墙保障）。支持Window 7+，macOS 10.10+，Linux amd64，Android 5.0+，当前不支持iOS系统（需要的读者参考：iOS翻墙指南）。免费版可支持浏览网页等应用，高速服务需要付费，为5欧元每月。
